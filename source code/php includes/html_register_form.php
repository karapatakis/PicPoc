...
<table>
    ...
    <tr>
        <td style="text-align:center;"><input required class="cred" type="radio" name="sex" value="male"> Male <input  class="cred" type="radio" name="sex" value="female"> Female <input  class="cred" type="radio" name="sex" value="other"> Other </td>
    </tr>
    <tr>
        <td>
            <h4 style="margin:0px 0px 0px 5px;">Select a profile picture: </h4><br>
            <input type="hidden" name="MAX_FILE_SIZE" value="41943040" />
            <input class="cred" type="file" name="upfile" style="margin:0px 5px 5px5px; width: 100%;">
            <br>
