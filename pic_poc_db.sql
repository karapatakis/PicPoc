...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2020 at 10:01 AM
...
CREATE TABLE `gallery` (
  ...
  `like_counter` int(30) NOT NULL,
  `user_id` int(30) NOT NULL,
  `upload_time` varchar(30) NOT NULL,
  `photo_size` int(50) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `profile_photo_path` varchar(60) NOT NULL,
